...
public class DataRetrievalServiceTest {
  ...
  @Before
  public void setUp() {
    dataRetrievalService = new DataRetrievalService(mockRestTemplate, "https://abc/handsets/list");
  }
  ...
  public void testGetHandsetRecords() throws ServiceException {
    ...
    List<Handset> handsetList = dataRetrievalService.getHandsetRecords();
  ...
  public void testGetHandsetRecordsResourceException() throws ServiceException {
    ...
    dataRetrievalService.getHandsetRecords();
  }
