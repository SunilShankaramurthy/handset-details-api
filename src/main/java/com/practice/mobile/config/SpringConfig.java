package com.practice.mobile.config;

import com.practice.mobile.exception.CustomResponseHandler;
...
public class SpringConfig {
  ...
  /**
   * Configures httpclient to retry in case of dependent service unavailability. This takes out
